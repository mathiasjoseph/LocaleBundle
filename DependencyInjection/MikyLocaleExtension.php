 ...
 */
class MikyLocaleExtension extends AbstractCoreExtension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $configuration = new Configuration($container->getParameter("miky_locale.use_default_entities"));
