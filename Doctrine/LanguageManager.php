...
namespace Miky\Bundle\LocaleBundle\Doctrine;


use Doctrine\Common\Persistence\ObjectManager;
use Miky\Bundle\LocationBundle\Webservices\GeoList\GeoListProvider;
use Seestock\AppBundle\Entity\Language;
    ...
    public function getArrayByName()
    {
        ...
        foreach ($this->locales as $l) {
            if ($this->requestStack->getCurrentRequest() != null) {
                ...
                $array[$l] = ucfirst(\Locale::getDisplayLanguage($l, "fr"));
            }
        }
        return $array;
    }

    public function getArrayAllIsoByName()
    {
        $array = array();

        foreach ($this->geoListProvider->getLanguageIsoList() as $l) {
            $array[$l] = ucfirst(\Locale::getDisplayLanguage($l, $this->requestStack->getCurrentRequest()->getLocale()));
        }
        return $array;
    }
